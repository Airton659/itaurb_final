...
import 'package:itaurb_transparente/views/home_tela.dart';
      ...
      body: Stack(
        children: [
          IntroductionScreen(
            ...
            // --- CORREÇÃO DE ALINHAMENTO HORIZONTAL AQUI ---
            // Adicionamos um padding horizontal para afastar os botões das bordas
            controlsPadding: const EdgeInsets.symmetric(horizontal: 40.0),
            
            pages: [
              PageViewModel(
                title: "Bem-vindo à Itaurb",
                body: "Todas as informações da Empresa de Desenvolvimento de Itabira na palma da sua mão.",
                image: Image.asset('assets/images/logo_itaurb2.png', width: 200),
                decoration: pageDecoration,
              ),
              PageViewModel(
                title: "Funciona Offline",
                body: "Consulte os horários da coleta de lixo do seu bairro mesmo sem conexão com a internet.",
                image: Icon(Icons.wifi_off_rounded, size: 120, color: theme.colorScheme.primary),
                decoration: pageDecoration,
              ),
              PageViewModel(
                title: "Alertas de Coleta",
                body: "Favorite seu bairro para receber notificações e nunca mais perder o dia da coleta de lixo.",
                image: Icon(Icons.notifications_active, size: 120, color: theme.colorScheme.primary),
                decoration: pageDecoration,
              ),
              PageViewModel(
                title: "Dicas de Uso",
                ...
                image: Icon(Icons.settings_suggest_outlined, size: 120, color: theme.colorScheme.primary),
                decoration: pageDecoration,
              ),
            ],
            ...
            next: Text('Avançar', style: TextStyle(fontWeight: FontWeight.w600, color: controlColor)),
